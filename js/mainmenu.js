...
searchini = function() {
  ...
  frm.onsubmit=function() {
    if(this.words.value=='Search www.primerdigital.com'||this.words.value=='') {
      alert('Please enter a search term.');
      this.words.focus();
      return false;
    }
  }
  wrd.onfocus=function() {if(this.value=='Search www.primerdigital.com'){this.value=''};}
  wrd.onblur=function() {if(this.value==''){this.value='Search www.primerdigital.com'};}
...
mail = function(name,domain,text,subject) {
  if (!domain) {domain='primerdigital.com'}
